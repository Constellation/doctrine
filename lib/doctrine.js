...
(function () {
    ...
    function isAllowedOptionalType(title) {
        return isParamTitle(title) || isProperty(title) || isReturnTitle(title);
    }

    function isTypeParameterRequired(title) {
        return !isAllowedOptionalType(title) &&
            (title === 'define' || title === 'enum' ||
            title === 'implements' || title === 'this' ||
            title === 'type' || title === 'typedef');
    }

    // Consider deprecation instead using 'isTypeParameterRequired' and 'Rules' declaration to pick when a type is optional/required
    // This would require changes to 'parseType'
    function isAllowedType(title) {
        return isAllowedOptionalType(title) || isTypeParameterRequired(title) ||
            title === 'throws' || title === 'const' || title === 'constant' ||
        ...
        TagParser.prototype.parseType = function () {
            ...
            if (isTypeParameterRequired(this._title)) {
                try {
                    ...
                    if (!this._tag.type && !this.addError('Missing or invalid tag type')) {
                        return false;
                    }
                } catch (error) {
                    this._tag.type = null;
                ...
                try {
                    ...
                    if (isAllowedOptionalType(this._title)) {
                        // Report error when an optional type is invalid.
                        this._tag.type = null;
